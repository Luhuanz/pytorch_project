...
static ONNXPlugin::DataType convert_trt_datatype(::onnx::TensorProto::DataType dt){
    switch(dt){
        case ::onnx::TensorProto::FLOAT: return ONNXPlugin::DataType::Float32;
        case ::onnx::TensorProto::FLOAT16: return ONNXPlugin::DataType::Float16;
        case ::onnx::TensorProto::INT32: return ONNXPlugin::DataType::Int32;
        case ::onnx::TensorProto::UINT8: return ONNXPlugin::DataType::UInt8;
        default:
            printf("Unsupport data type %d\n", dt);
            return ONNXPlugin::DataType::Unknow;
    }
}
...
DEFINE_BUILTIN_OP_IMPORTER(Plugin)
{
    ...
    for(int i = 0; i < weights.size(); ++i){
        ...
        std::shared_ptr<ONNXPlugin::Weight> dweight(new ONNXPlugin::Weight(dims, onnx_dtype));
        
        if(onnx_dtype == ONNXPlugin::DataType::Unknow){
